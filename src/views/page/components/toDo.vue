...
<script lang="ts" setup>
  import ToDoList from '@/views/page/components/toDoList.vue'
  import ToDoForm from '@/views/page/components/toDoForm.vue'
  import type { toDoListInfoType, toDoListItemType } from '@/views/page/components/types'
